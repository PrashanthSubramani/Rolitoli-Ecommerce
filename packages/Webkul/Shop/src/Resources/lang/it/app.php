...
return [
    'customers' => [
        ...
        'account' => [
            ...
            'profile' => [
                ...
                'other'                   => 'Altro',
                'order-pending'           => 'Impossibile eliminare l\'account cliente perché ci sono Ordini in sospeso o in stato di elaborazione.',
                'phone'                   => 'Telefono',
                'save'                    => 'Salva',
                'subscribe-to-newsletter' => 'Iscriviti alla newsletter',
                'title'                   => 'Profilo',
                'unmatch'                 => 'La vecchia password non corrisponde.',
            ...
            'addresses' => [
                ...
                'default-delete'   => 'L\'indirizzo predefinito non può essere cambiato.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Valuta',
                'footer-text'            =>  '© ' . date('Y') . ' Copyright, Rolitoli',
                'locale'                 => 'Lingua',
        ...
        'products' => [
            'card' => [
                'add-to-compare'     => 'Articolo aggiunto con successo all\'elenco di confronto.',
                'already-in-compare' => 'L\'articolo è già stato aggiunto all\'elenco di confronto.',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'missing-links'             => 'Mancano i link scaricabili per questo prodotto.',
        ...
        'onepage' => [
            'addresses' => [
                'billing' => [
                    ...
                    'last-name'            => 'Cognome',
                    'postcode'             => 'CAP',
                    'same-billing-address' => 'L\'indirizzo è lo stesso del mio indirizzo di fatturazione',
                    'street-address'       => 'Indirizzo',
                    'state'                => 'Stato',
