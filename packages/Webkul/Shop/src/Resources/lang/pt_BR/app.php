...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright current_year, Rolitoli',
        ...
        'account' => [
            ...
            'profile' => [
                ...
                'delete-failed'           => 'Erro ao excluir o cliente.',
                'delete'                  => 'Excluir',
                'email'                   => 'E-mail',
                ...
                'other'                   => 'Outro',
                'order-pending'           => 'Não é possível excluir a conta do cliente porque há pedido(s) pendente(s) ou em processamento.',
                'phone'                   => 'Telefone',
                'save'                    => 'Salvar',
                'subscribe-to-newsletter' => 'Assinar boletim informativo',
                'title'                   => 'Perfil',
            ...
            'orders' => [
                ...
                'view' => [
                    ...
                    'shipments' => [
                        'individual-shipment' => 'Envio #:shipment_id',
                        'product-name'        => 'Nome',
                        'qty'                 => 'Qty',
                        'sku'                 => 'SKU',
                        'shipments'           => 'Envios',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'currency'               => 'Moeda',
                'footer-text'            => '© Direitos Autorais 2010 - 2023, Webkul Software (Registrada na Índia). Todos os direitos reservados.',
                'locale'                 => 'Localização',
        ...
        'products' => [
            'card' => [
                'add-to-compare'     => 'Item adicionado com sucesso para a lista de comparação.',
                'already-in-compare' => 'O item já está adicionado à lista de comparação.',
    ...
    'checkout' => [
        ...
        'cart' => [
            ...
            'missing-links'             => 'Links para download estão faltando para este produto.',
            ...
            'summary' => [
                ...
                'delivery-charges'    => 'Custos de Entrega',
        ...
        'onepage' => [
            'addresses' => [
                'billing' => [
                    ...
                    'last-name'            => 'Sobrenome',
                    'postcode'             => 'CEP',
                    'same-billing-address' => 'O endereço é o mesmo do endereço de cobrança',
                    'street-address'       => 'Endereço',
                    'state'                => 'Estado',
    ...
    'emails' => [
        ...
        'orders' => [
            ...
            'sku'               => 'SKU',
            'subtotal'          => 'Subtotal',
            'shipping-handling' => 'Manuseio e Entrega',
